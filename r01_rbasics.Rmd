...
For the following exercise, download a <a href = "file/report01_temp.R" download>template</a> (R script file).
...
For the following exercise, download a <a href="file/report02_temp.R" download>template</a> (R script file).
